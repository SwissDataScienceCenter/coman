...
static REGEX_ATTACH_COMPUTE_SYSTEM_NAME_JOBS_JOB_ID_ATTACH_PUT_REQUEST_JOB_ID: std::sync::LazyLock<
    regex::Regex,
> = std::sync::LazyLock::new(|| {
    regex::Regex::new("^[a-zA-Z0-9]+$").expect("invalid regex")
});
...
pub struct AttachComputeSystemNameJobsJobIdAttachPutRequest {
    ...
    #[validate(
        length(min = 1),
        regex(
            path = "REGEX_ATTACH_COMPUTE_SYSTEM_NAME_JOBS_JOB_ID_ATTACH_PUT_REQUEST_JOB_ID"
        )
    )]
    pub job_id: String,
    ///## Schema
...
impl AttachComputeSystemNameJobsJobIdAttachPutRequest {
    ...
    pub fn render_path(&self) -> String {
        format!(
            "/compute/{}/jobs/{}/attach", oas3_gen_support::percent_encode_path_segment(&
...
impl DeleteJobCancelComputeSystemNameJobsJobIdDeleteRequest {
    ...
    pub fn render_path(&self) -> String {
        format!(
            "/compute/{}/jobs/{}", oas3_gen_support::percent_encode_path_segment(& self
            .system_name.to_string()), oas3_gen_support::percent_encode_path_segment(&
...
impl DeleteRmFilesystemSystemNameOpsRmDeleteRequest {
    ...
    pub fn render_path(&self) -> String {
        ...
        let mut path = format!(
            "/filesystem/{}/ops/rm", oas3_gen_support::percent_encode_path_segment(& self
            .system_name.to_string())
        );
        let mut prefix = '\0';
        prefix = if prefix == '\0' { '?' } else { '&' };
        write!(
            & mut path, "{prefix}path={}",
...
impl DeleteRmFilesystemSystemNameTransferRmDeleteRequest {
    ...
    pub fn render_path(&self) -> String {
        use std::fmt::Write as _;
        let mut path = format!(
            "/filesystem/{}/transfer/rm", oas3_gen_support::percent_encode_path_segment(&
            self.system_name.to_string())
        );
        let mut prefix = '\0';
        prefix = if prefix == '\0' { '?' } else { '&' };
...
impl GetFileFilesystemSystemNameOpsFileGetRequest {
    ...
    pub fn render_path(&self) -> String {
        use std::fmt::Write as _;
        let mut path = format!(
            "/filesystem/{}/ops/file", oas3_gen_support::percent_encode_path_segment(&
            self.system_name.to_string())
        );
        let mut prefix = '\0';
        prefix = if prefix == '\0' { '?' } else { '&' };
...
impl GetHeadFilesystemSystemNameOpsHeadGetRequest {
    ...
    pub fn render_path(&self) -> String {
        use std::fmt::Write as _;
        let mut path = format!(
            "/filesystem/{}/ops/head", oas3_gen_support::percent_encode_path_segment(&
            self.system_name.to_string())
        );
        let mut prefix = '\0';
        prefix = if prefix == '\0' { '?' } else { '&' };
...
impl GetJobMetadataComputeSystemNameJobsJobIdMetadataGetRequest {
    ...
    pub fn render_path(&self) -> String {
        format!(
            ...
            oas3_gen_support::percent_encode_path_segment(& self.system_name
            .to_string()), oas3_gen_support::percent_encode_path_segment(& self.job_id
            .to_string())
        )
    }
}
...
impl GetLsFilesystemSystemNameOpsLsGetRequest {
    ...
    pub fn render_path(&self) -> String {
        use std::fmt::Write as _;
        let mut path = format!(
            "/filesystem/{}/ops/ls", oas3_gen_support::percent_encode_path_segment(& self
            .system_name.to_string())
        );
        let mut prefix = '\0';
        prefix = if prefix == '\0' { '?' } else { '&' };
...
impl GetStatFilesystemSystemNameOpsStatGetRequest {
    ...
    pub fn render_path(&self) -> String {
        use std::fmt::Write as _;
        let mut path = format!(
            "/filesystem/{}/ops/stat", oas3_gen_support::percent_encode_path_segment(&
            self.system_name.to_string())
        );
        let mut prefix = '\0';
        prefix = if prefix == '\0' { '?' } else { '&' };
...
impl GetSystemNodesStatusSystemNameNodesGetRequest {
    ...
    pub fn render_path(&self) -> String {
        format!(
            "/status/{}/nodes", oas3_gen_support::percent_encode_path_segment(& self
            .system_name.to_string())
        )
    }
}
...
impl GetSystemPartitionsStatusSystemNamePartitionsGetRequest {
    ...
    pub fn render_path(&self) -> String {
        format!(
            "/status/{}/partitions", oas3_gen_support::percent_encode_path_segment(& self
            .system_name.to_string())
        )
    }
}
...
impl GetSystemReservationsStatusSystemNameReservationsGetRequest {
    ...
    pub fn render_path(&self) -> String {
        format!(
            "/status/{}/reservations", oas3_gen_support::percent_encode_path_segment(&
            self.system_name.to_string())
        )
    }
}
...
impl GetTailFilesystemSystemNameOpsTailGetRequest {
    ...
    pub fn render_path(&self) -> String {
        use std::fmt::Write as _;
        let mut path = format!(
            "/filesystem/{}/ops/tail", oas3_gen_support::percent_encode_path_segment(&
            self.system_name.to_string())
        );
        let mut prefix = '\0';
        prefix = if prefix == '\0' { '?' } else { '&' };
...
impl GetUserinfoStatusSystemNameUserinfoGetRequest {
    ...
    pub fn render_path(&self) -> String {
        format!(
            "/status/{}/userinfo", oas3_gen_support::percent_encode_path_segment(& self
            .system_name.to_string())
        )
    }
}
...
impl GetViewFilesystemSystemNameOpsViewGetRequest {
    ...
    pub fn render_path(&self) -> String {
        use std::fmt::Write as _;
        let mut path = format!(
            "/filesystem/{}/ops/view", oas3_gen_support::percent_encode_path_segment(&
            self.system_name.to_string())
        );
        let mut prefix = '\0';
        prefix = if prefix == '\0' { '?' } else { '&' };
...
impl MoveMvFilesystemSystemNameTransferMvPostRequest {
    ...
    pub fn render_path(&self) -> String {
        format!(
            "/filesystem/{}/transfer/mv", oas3_gen_support::percent_encode_path_segment(&
            self.system_name.to_string())
        )
    }
}
...
impl PostCpFilesystemSystemNameTransferCpPostRequest {
    ...
    pub fn render_path(&self) -> String {
        format!(
            "/filesystem/{}/transfer/cp", oas3_gen_support::percent_encode_path_segment(&
            self.system_name.to_string())
        )
    }
}
...
impl PostExtractFilesystemSystemNameOpsExtractPostRequest {
    ...
    pub fn render_path(&self) -> String {
        format!(
            "/filesystem/{}/ops/extract", oas3_gen_support::percent_encode_path_segment(&
            self.system_name.to_string())
        )
    }
}
...
impl PostMkdirFilesystemSystemNameOpsMkdirPostRequest {
    ...
    pub fn render_path(&self) -> String {
        format!(
            "/filesystem/{}/ops/mkdir", oas3_gen_support::percent_encode_path_segment(&
            self.system_name.to_string())
        )
    }
}
...
impl PostSymlinkFilesystemSystemNameOpsSymlinkPostRequest {
    ...
    pub fn render_path(&self) -> String {
        format!(
            "/filesystem/{}/ops/symlink", oas3_gen_support::percent_encode_path_segment(&
            self.system_name.to_string())
        )
    }
}
...
impl PostUploadFilesystemSystemNameOpsUploadPostRequest {
    ...
    pub fn render_path(&self) -> String {
        use std::fmt::Write as _;
        let mut path = format!(
            "/filesystem/{}/ops/upload", oas3_gen_support::percent_encode_path_segment(&
            self.system_name.to_string())
        );
        let mut prefix = '\0';
        prefix = if prefix == '\0' { '?' } else { '&' };
...
impl PutChmodFilesystemSystemNameOpsChmodPutRequest {
    ...
    pub fn render_path(&self) -> String {
        format!(
            "/filesystem/{}/ops/chmod", oas3_gen_support::percent_encode_path_segment(&
            self.system_name.to_string())
        )
    }
}
...
impl PutChownFilesystemSystemNameOpsChownPutRequest {
    ...
    pub fn render_path(&self) -> String {
        format!(
            "/filesystem/{}/ops/chown", oas3_gen_support::percent_encode_path_segment(&
            self.system_name.to_string())
        )
    }
}
